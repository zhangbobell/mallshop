...
CREATE TABLE `iweb_ad_manage` (
  ...
  PRIMARY KEY  (`id`),
  index (`position_id`,`goods_cat_id`,`start_time`,`end_time`),
  index (`order`)
...
--
-- 导出表中的数据 `iweb_takeself`
--
DROP TABLE IF EXISTS `iweb_takeself`;
CREATE TABLE `iweb_takeself` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='商品物流自提地点';

--
-- 导出表中的数据 `iweb_ad_manage`
--
INSERT INTO `iweb_ad_manage` VALUES (16, '首页左上方广告', 1, 5, 'http://www.aircheng.com', 99, 0, 0, '2014-05-01', '2020-08-05', 'upload/2011/06/07/20110607105359556.png', '首页左上方广告',0);
INSERT INTO `iweb_ad_manage` VALUES (23, '首页中部通栏广告', 1, 6, 'http://www.aircheng.com', 99, 0, 0, '2014-05-03', '2020-06-11', 'upload/2011/06/07/20110607105518688.png', '首页中部通栏广告',0);
INSERT INTO `iweb_ad_manage` VALUES (18, '首页右上方', 1, 7, 'http://www.aircheng.com', 99, 0, 0, '2014-05-02', '2020-06-30', 'upload/2011/06/07/20110607105608864.png', '首页右上方',0);
INSERT INTO `iweb_ad_manage` VALUES (19, '商品搜索结果页198*120', 1, 8, 'http://www.aircheng.com', 99, 198, 120, '2014-05-05', '2020-06-10', 'upload/2011/06/07/20110607105655941.png', '1',0);
INSERT INTO `iweb_ad_manage` VALUES (22, '文章公告内容页左侧', 1, 10, 'http://www.aircheng.com', 99, 0, 0, '2014-05-02', '2020-12-10', 'upload/2011/06/07/20110607105620728.png', '1',0);
INSERT INTO `iweb_ad_manage` VALUES (24, '首页中部通栏广告', 1, 6, 'http://www.aircheng.com', 99, 0, 0, '2014-05-03', '2020-06-11', 'upload/2011/06/07/20110607105547573.png', '首页中部通栏广告',0);

--
-- 导出表中的数据 `iweb_ad_position`
--

INSERT INTO `iweb_ad_position` VALUES (1, '页面顶部通栏广告条', 0, 0, 1, 1);
INSERT INTO `iweb_ad_position` VALUES (5, '首页左上方748*299', 748, 299, 1, 1);
INSERT INTO `iweb_ad_position` VALUES (6, '首页中部通栏', 0, 0, 1, 1);
INSERT INTO `iweb_ad_position` VALUES (7, '首页右上方198*104', 198, 104, 1, 1);
INSERT INTO `iweb_ad_position` VALUES (8, '商品搜索结果页左侧', 198, 120, 1, 1);
INSERT INTO `iweb_ad_position` VALUES (10, '文章-公告内容页左册', 0, 0, 1, 1);
...
INSERT INTO `iwebshop_right` VALUES (NULL, '[商品]商品列表', 'goods@goods_list', 0);
INSERT INTO `iwebshop_right` VALUES (NULL, '[商品]商品添加修改', 'goods@update_price,goods@update_commend,goods@update_store,goods@goods_stats,goods@goods_img_upload,goods@goods_edit,goods@goods_update,goods@member_price,goods@model_init,goods@search_spec,goods@select_spec,goods@collect_import,goods@collect_goods,goods@ajax_sort', 0);
...
INSERT INTO `iwebshop_right` VALUES (NULL, '[会员]商户列表', 'member@seller_list', 0);
INSERT INTO `iwebshop_right` VALUES (NULL, '[会员]商户添加修改', 'member@seller_edit,member@seller_add,member@ajax_seller_lock', 0);
INSERT INTO `iwebshop_right` VALUES (NULL, '[会员]商户删除', 'member@seller_del', 0);
INSERT INTO `iwebshop_right` VALUES (NULL, '[会员]商户回收站', 'member@seller_recycle_list,member@seller_recycle_del,member@seller_recycle_restore', 0);
...
INSERT INTO `iwebshop_right` VALUES (NULL, '[订单]订单打印', 'order@merge_template,order@pick_template,order@shop_template,order@print_template_update,order@print_template', 0);
...
INSERT INTO `iwebshop_right` VALUES (NULL, '[统计]结算单列表', 'market@bill_list', 0);
INSERT INTO `iwebshop_right` VALUES (NULL, '[统计]结算单修改审核', 'market@bill_edit,market@bill_update', 0);
INSERT INTO `iwebshop_right` VALUES (NULL, '[统计]结算单删除', 'market@bill_del', 0);
INSERT INTO `iwebshop_right` VALUES (NULL, '[统计]货款明细列表', 'market@order_goods_list', 0);
...
INSERT INTO `iwebshop_delivery` (`id`, `name`, `description`, `area_groupid`, `firstprice`, `secondprice`, `type`, `first_weight`, `second_weight`, `first_price`, `second_price`, `status`, `sort`, `is_save_price`, `save_rate`, `low_price`, `price_type`, `open_default`, `is_delete`) VALUES
...
INSERT INTO `iweb_payment` VALUES (0, '货到付款', 2, 'freight_collect', '货到付款', '/payments/logos/pay_freight_collect.jpg', 1, 99, NULL, 0.00, 1, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '预存款', 1, 'balance', '预存款是客户在您网站上的虚拟资金帐户。', '/payments/logos/pay_deposit.gif',0,99,NULL,0.00,1,NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '网银在线', 1, 'chinabank', '网银在线是中国领先的电子支付解决方案提供商之一。 <a href="http://www.chinabank.com.cn/" target="_blank">立即申请</a>', '/payments/logos/pay_chinabank.gif',1, 99, NULL, 0.00, 1, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '腾讯财付通', 1, 'tenpay', '财付通是腾讯公司创办的中国领先的在线支付平台，致力于为互联网用户和企业提供安全、便捷、专业的在线支付服务。 <a href="https://www.tenpay.com/v2/" target="_blank">立即申请</a>','/payments/logos/pay_tenpay.gif', 1, 99, NULL, 0.00, 1, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '快钱', 1, 'bill99', '快钱是国内领先的独立第三方支付企业，旨在为各类企业及个人提供安全、便捷和保密的支付清算与账务服务。 <a href="https://www.99bill.com/" target="_blank">立即申请</a>', '/payments/logos/pay_99bill.gif', 1, 99, NULL, 0.00, 1, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '支付宝', 1, 'trade_alipay', '担保交易支付方式，淘宝买家最熟悉的付款方式：买家先将交易资金存入支付宝并通知卖家发货，买家确认收货后资金自动进入卖家支付宝账户，完成交易。 <a href="http://www.alipay.com/" target="_blank">立即申请</a>', '/payments/logos/pay_alipay.gif', 1, 99, NULL, 0.00, 1, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '支付宝', 1, 'direct_alipay', '即时到帐支付方式，网上交易时，买家的交易资金直接打入卖家支付宝账户，快速回笼交易资金。 <a href="http://www.alipay.com/" target="_blank">立即申请</a>', '/payments/logos/pay_alipay.gif', 1, 99, NULL, 0.00, 1, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '支付宝', 1, 'alipay', '担保+即使双接口支付方式，给于买家充足的自主选择权。 <a href="http://www.alipay.com/" target="_blank">立即申请</a>', '/payments/logos/pay_alipay.gif', 0, 99, NULL, 0.00, 1, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '贝宝', 1, 'paypal', '是全球最大的在线支付平台，同时也是目前全球贸易网上支付标准。<a href="https://www.paypal-biz.com/" target="_blank">立即申请</a>', '/payments/logos/pay_paypal.gif', 1, 99, NULL, 0.00, 1, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '微信', 1, 'wechat', '微信扫一扫支付接口。<a href="http://www.aircheng.com/" target="_blank">立即申请</a>', '/payments/logos/pay_wechat.gif', 1, 99, NULL, 0.00, 1, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '线下支付', 2, 'offline', '线下付款结算', '/payments/logos/pay_offline.gif', 0, 99, NULL, 0.00, 0, NULL);
INSERT INTO `iweb_payment` VALUES (NULL, '银信证', 1, 'cipay', '银信证支付','/payments/logos/pay_cipay.jpg',0,99,NULL,0.00,0,NULL);