				...
				<table class="form_table">
					...
					<tr>
						...
						<td>
							<select class="auto" name="seller_id">
								...
								<?php $query = new IQuery("seller");$items = $query->find(); foreach($items as $key => $item){?>
					...
					<tr>
						...
						<td>
							...
							<?php }else{?>
							系统暂无商品分类，<a href='<?php echo IUrl::creatUrl("/goods/category_edit");?>' class='orange'>请点击添加分类</a>
							<?php }?>
						</td>
					</tr>
					<tr>
